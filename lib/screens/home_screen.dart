...
class _HomeScreenState extends State<HomeScreen>
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          title: const Text('Floating Bottom Bar'),
        ...
        body: BottomBar(
          ...
          iconWidth: 28,
          icon: (w, h) => Center(
            child: Icon(Icons.arrow_upward_rounded, size: w, color: unselectedColor),
          ),
          ...
          child: TabBar(
            ...
            tabs: [
              _tabIcon(Icons.home, currentPage == 0 ? colors[0] : unselectedColor),
              _tabIcon(Icons.search, currentPage == 1 ? colors[1] : unselectedColor),
              _tabIcon(Icons.favorite, currentPage == 2 ? colors[2] : unselectedColor),
              _tabIcon(Icons.settings, currentPage == 3 ? colors[3] : unselectedColor),
            ],
          ),
        ),
      ),
